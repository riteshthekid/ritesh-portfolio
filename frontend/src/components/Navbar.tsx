...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Hide navbar if scrolled past the hero section (100vh)
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 py-3 bg-white/5 backdrop-blur-md border border-white/10 rounded-full shadow-[0_8px_32px_rgba(0,0,0,0.3)]">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm font-medium text-gray-300">
              <a href="#home" className="hover:text-white hover:scale-110 transition-all duration-300">Home</a>
              ...
              <a href="#contact" className="hover:text-white hover:scale-110 transition-all duration-301">Contact</a>
            </div>
